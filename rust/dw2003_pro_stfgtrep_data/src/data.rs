...
impl Evolution {
	...
	pub const fn rookie(level: u16, to: DigimonId) -> Self {
		assert!(to.is_valid_digivolution(), "Evolution destination is not valid");
		Self {
			to,
			un0: 0x0000,
	...
	pub const fn standard(from: DigimonId, level: u16, to: DigimonId) -> Self {
		assert!(from.is_valid_digivolution(), "Evolution source is not valid");
		assert!(to.is_valid_digivolution(), "Evolution destination is not valid");
		Self {
			to,
			un0: 0x0000,
	...
	pub const fn dna(lhs_from: DigimonId, lhs_level: u16, rhs_from: DigimonId, rhs_level: u16, to: DigimonId) -> Self {
		assert!(lhs_from.is_valid_digivolution(), "Evolution 1st source is not valid");
		assert!(rhs_from.is_valid_digivolution(), "Evolution 2nd source is not valid");
		assert!(to.is_valid_digivolution(), "Evolution destination is not valid");
		Self {
			to,
			un0: 0x0000,
